...
```
Получаем невыровненный вектор по адресу, потому что вся структура выровнена по 16 байт, а вектор съехал на 1. А оно вам нужно? Учитывая, что некоторые процессоры не умеют в невыровненный доступ
